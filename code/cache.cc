	...
	switch ((protocol_name) protocol_no) {
                        ...
                        case MOESI:
                                return new MOESI::MOESI(size, assoc,block_size,
                                                        num_processors, processor_num); 
                        case MI:
                                return new MI::MI(size, assoc,block_size,
                                                        num_processors, processor_num);
                        case MESI:
                                return new MESI::MESI(size, assoc,block_size,
                                                        num_processors, processor_num);
                        case writethrough:
                                return new writethrough::writethrough(size, assoc,block_size,
                                                        num_processors, processor_num); 
			case MESI_dsm:
                                return new MESI::MESI(size, assoc, block_size, num_processors, processor_num);
			case MOESI_dsm:
                                return new MOESI::MOESI(size, assoc, block_size, num_processors, processor_num);
                        default:
                                return NULL;
        }
}
