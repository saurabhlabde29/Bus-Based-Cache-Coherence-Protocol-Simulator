...
const char* protocol_names[ ] = {"MSI", "MOSI", "MOESI", "MI", "MESI", "writethrough", "MESI with FBV", "MESI with SCI" ,"MOESI with FBV", "MOESI with SCI" };
...
int main(int argc, char *argv[]){
	...
	if (project == "smp"){
		...
		simulate_caches(fname, project, instr_count);
...
////
void simulate_caches(char *fname, string project, int instr_count){
	ifstream fin;
    	FILE * pFile;
        int proc_no, addr;
    	char op;
